# Proyecto: Documentación colaborativa de infraestructura LAMP
...
Diseñar y documentar el despliegue de una infraestructura LAMP para una PYME.

## Documentación

- [Análisis](docs/01-analisis.md)
- [Diseño](docs/02-diseno.md)
- [Planificación](docs/03-planificacion.md)
- [Servidor Web](docs/04-instalacion/servidor-web.md)
...
- [Recuperación](docs/06-recuperacion.md)